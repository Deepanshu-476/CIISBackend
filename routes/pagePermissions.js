...
const APP_PAGES = [
  ...
  { pageKey: 'adminproject', name: 'Manage Projects', path: '/ciisUser/adminproject' },
  ...
  { pageKey: 'client-my-services', name: 'My Services', path: '/client/my-services' },
  { pageKey: 'client-tasks-updates', name: 'Tasks & Updates', path: '/client/tasks-updates' },
  { pageKey: 'client-marketplace', name: 'Explore Services', path: '/client/marketplace' },
  { pageKey: 'client-support-tickets', name: 'Meetings', path: '/client/support-tickets' },
  { pageKey: 'client-documents', name: 'Documents', path: '/client/documents' },
  { pageKey: 'client-payments', name: 'Payments', path: '/client/payments' },
  ...
  { pageKey: 'change-password', name: 'Change Password', path: '/ciisUser/change-password' },
  { pageKey: 'user-dashboard', name: 'User Dashboard', path: '/ciisUser/user-dashboard' },
  { pageKey: 'project', name: 'My Projects', path: '/ciisUser/project' },
